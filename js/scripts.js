...
mr = function(a, b, c, d) {
    ...
    var e = function(b) {
        ...
        }), b('form.form-email, form[action*="list-manage.com"], form[action*="s-troya.ru"]').attr("novalidate", !0).unbind("submit").on("submit", a.forms.submit), b(d).on("change, input, paste, keyup", ".attempted-submit .field-error", function() {
    ...
    return a.forms.documentReady = e, a.forms.submit = function(d) {
        ...
        if (j.find(".form-error, .form-success").remove(), m.attr("data-text", m.text()), h = k.attr("data-error") ? k.attr("data-error") : "Please fill all fields correctly", i = k.attr("data-success") ? k.attr("data-success") : "Thanks, we'll be in touch shortly", j.append('<div class="form-error" style="display: none;">' + h + "</div>"), j.append('<div class="form-success" style="display: none;">' + i + "</div>"), f = j.find(".form-error"), g = j.find(".form-success"), k.addClass("attempted-submit"), -1 !== l.indexOf("s-troya.ru") || -1 !== l.indexOf("kuralesov.com"))
            if ("undefined" != typeof o && o !== !1 && f.html(o), 1 !== a.forms.validateFields(k)) {
                ...
                try {
                    b.ajax({
                        ...
                        success: function(b) {
                            (m.removeClass("btn--loading"), e = k.attr("data-success-redirect"), "undefined" != typeof e && e !== !1 && "" !== e ? c.location = e : (a.forms.resetForm(k), a.forms.showFormSuccess(g, f, 1e3, 5e3, 500)))
                        }
                    })
                } catch (p) {
            ...
            "undefined" != typeof o && o !== !1 && f.text(o), n = a.forms.validateFields(k), 1 === n ? a.forms.showFormError(g, f, 1e3, 5e3, 500) : (k.removeClass("attempted-submit"), f.fadeOut(200), m.addClass("btn--loading"), jQuery.ajax({
                type: "POST",
                url: "",
    ...
    return a.maps.documentReady = e, a.maps.initAPI = function() {
        ...
        "undefined" != typeof c.google && "undefined" != typeof c.google.maps && b(".map-container[data-maps-api-key]").each(function() {
            var a,
                ...
                j = "undefined" != typeof g.attr("data-map-zoom") && "" !== g.attr("data-map-zoom") ? 1 * g.attr("data-map-zoom") : 16,
                ...
                p = "undefined" != typeof g.attr("data-marker-image") ? g.attr("data-marker-image") : "/wp-content/themes/stroya/img/mapmarker.png",
                q = "Мы тут",
                r = b(d).width() > 766 ? !0 : !1,
                s = {
                    draggable: r,
            ...
            "undefined" != typeof g.attr("data-marker-title") && "" !== g.attr("data-marker-title") && (q = g.attr("data-marker-title")), void 0 !== o && "" !== o[0] ? n.geocode({
                ...
                if (b == google.maps.GeocoderStatus.OK) {
                    ...
                    d.setCenter(a[0].geometry.location), o.forEach(function(a) {
                        var b;
                        if (p = {
                            url: "undefined" == typeof c.mr_variant ? p : "/wp-content/themes/stroya/img/mapmarker.png",
                            ...
                            a.indexOf("[nomarker]") < 0 && (b = new google.maps.Geocoder, b.geocode({
    ...
    var e = function(b) {
        var c,
            ...
            g,
            h;
        b('form[action*="s-troya.ru"]').each(function() {
    ...
    return a.newsletters.documentReady = e, a.newsletters.prepareAjaxAction = function(a) {
        ...
        /kuralesov\.com/.test(c) && (c = c.replace("/post?", "/post-json?") + "&c=?", "//" == c.substr(0, 2) && (c = "http:" + c)), /kuralesov\.com/.test(c) && (c += "?callback=?"), b(a).attr("action", c)
    }, a.components.documentReady.push(e), a
}(mr, jQuery, window, document), mr = function(a, b, c, d) {
    "use strict";
    a.notifications = {};
...
$(".call-trigger").click(function(event) {
    $(".pozvonim-button-phone").click();
});
...
$("a[href^=#]").click(function(event) {
    history.pushState('', document.title, $(event.target).attr("href"))
});